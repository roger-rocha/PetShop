...
class ActivityLogResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Super\Resources\ActivityLogResource\Pages\ListActivityLogs::route('/'),
            'create' => \App\Filament\Super\Resources\ActivityLogResource\Pages\CreateActivityLog::route('/create'),
            'edit' => \App\Filament\Super\Resources\ActivityLogResource\Pages\EditActivityLog::route('/{record}/edit'),
        ];
    }
